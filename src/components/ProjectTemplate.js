        ...
        return (
            <div className='PTcontainer'>
                ...
                <div className='PTbuttons'>
                    <a rel="noopener noreferrer" target="_blank" href={this.props.source} className='PTbtn'>View Source  <i class="fas fa-code-branch"></i></a>
                    <a rel="noopener noreferrer" target="_blank" href={this.props.demo} className='PTbtn'>View Demo  <i class="fas fa-globe-americas"></i></a>
